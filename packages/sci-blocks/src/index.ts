...
export { registerSciBlocks, FORMULA_LANG, SIM_LANG, EXERCISE_LANG, SIMSCRIPT_LANG, FIGURE_LANG, TABLE_LANG, CALLOUT_LANG, LAW_LANG, setInkRecognizer } from './register';
