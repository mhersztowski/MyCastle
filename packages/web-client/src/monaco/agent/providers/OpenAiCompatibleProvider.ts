/**
 * OpenAI-compatible provider (OpenAI, Ollama, Azure, LiteLLM, vLLM, custom endpoints)
 */

import type { AiChatRequest, AiChatResponse, AiProviderConfig, AiProvider } from '../types';
