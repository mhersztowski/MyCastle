/**
 * Read-only CAD 3D viewer — converts CAD project to Three.js scene and shows in SimpleViewer.
 * URL: /viewer/cad3d/{vfsPath}  e.g. /viewer/cad3d/users/default/projects/mypart
 */
