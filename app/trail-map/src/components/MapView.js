...
import { elevationToColor, slopeToColor, solidColor } from '../utils/colors';
import { routeBounds } from '../utils/routeAnalysis';
export function MapView({ routes, selectedRouteId, mapStyle, colorMode, viewMode, animPosition, hover, onHover, onSelectRoute, }) {
        ...
        for (const route of routes) {
            ...
            const getColor = (seg) => {
                if (colorMode === 'elevation')
                    return elevationToColor(seg.elevation, minElev, maxElev);
                if (colorMode === 'slope')
                    return slopeToColor(seg.slope);
