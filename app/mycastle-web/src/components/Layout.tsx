      ...
      return [
        ...
        },
        {
          text: 'IoT', icon: <RouterIcon />, children: [
            ...
            { text: 'Edytor Konwersacji', icon: <AccountTreeIcon />, path: `/user/${userName}/iot/aura/conversation-editor` },
          ],
        },
        {
          text: 'Pim', icon: <AppsIcon />, children: [
            ...
            { text: 'Projects 2', icon: <ViewKanbanIcon />, path: `/user/${userName}/pim/projects2` },
