...
import { PersonNode, TaskNode, ProjectNode, EventNode, ShoppingListNode } from '@mhersztowski/core';
import { PersonsModel, TasksModel, ProjectsModel, EventsModel, ShoppingListsModel, ShoppingItemModel } from '@mhersztowski/core';
