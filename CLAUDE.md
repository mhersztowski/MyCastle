...
- Strony:
    ...
    - **Menu „Programming"** (Layout, między Electronics a IoT): pozycje **UML** → `/user/:userName/programming/uml` (full-bleed, lazy-loaded) oraz **MinisC** → `/user/:userName/programming/minisc`. Ikony: IntegrationInstructions (grupa) + Schema (UML) + Memory (MinisC).
